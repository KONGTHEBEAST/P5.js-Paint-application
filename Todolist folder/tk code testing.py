...
path = "c:\Users\morga\OneDrive\Desktop\Todolist folder\todolist project.py"
service = Service(executable_path=path)
website =  "https://jobs.selcobw.com/job/part-time-checkout-assistant-35/apply?source=google.com"
